     ...
     while (1):
        ...
        try:
            ...
            if 'wikipedia' in queuery:
                ...
                codepath = "C:\\Users\\prince kumar\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            ...
            elif "stoplisting" in query or "stop" in query or "can u stop it evi" in query or "stop it" in query:
                speak("ohkk Sir . i am slepping now")
                stoplisting()
            ...
            elif "will you my gf" in query:
                speak("no ways. sorry sir. Try next time.")
                s = takecommend().lower()
                speak("ohk")
                ...
                music_dir = "C:\\Users\\prince kumar\\Desktop\\my"
            ...
            elif "know prince" in queuery:
                speak(
                    f"yes{sex} i know him becuase of him im able to talk to you he is a very nice person would you like to know more about mister prince kumar")
                s = takecommend().lower()
                if s == "yes":
                    me1()
                else:
